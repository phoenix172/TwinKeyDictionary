...
using TwinKeyDictionary;

namespace TwinKeyDictionaryTests
{
    [TestFixture]
    public class TwinKeyDictionaryTest
    {
        ...
        public void Add_WithPrimaryKey_ContainsRecordWithDefaultSecondaryKey()
        {
            ...
            Assert.That(_dictionary.Contains(new KeyValuePair<Tuple<int,string>, string>
                (Tuple.Create(1, default(string)), "stamat")));
        }
        ...
        {
            bool success = _dictionary.TryGetValue(Tuple.Create(1, "bsd"), out string value);
